...
public class CameraController : MonoBehaviour
{
    ...
    {   //if (IsGameStopped) return;
        ...
        //if(Mathf.Abs(cameraDistance - Vector3.Distance(Camera.main.transform.position, m_pivot.transform.position)) >= 5f)
        //{
        //    Camera.main.transform.LookAt(m_pivot, Vector3.up);
        //    Camera.main.transform.position = m_pivot.position;
        //}
        //cameraDistance = Vector3.Distance(Camera.main.transform.position, m_pivot.transform.position);
